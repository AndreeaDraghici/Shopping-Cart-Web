...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
              ...
              <script>
               ...
               <input id="myInput" type="text" placeholder="Normal search... " style="
                      padding: 12px 20px;
                      margin: 8px 0;
              ...
              <head>
                  ...
                  <script src="~/Scripts/Lucene.Net.dll"></script>
            ...
            <script>
             ...
             <input id="myInput2" type="text" placeholder=" Search a product... " style="
                      padding: 12px 20px;
                      margin: 8px 0;
                      box-sizing: border-box;
